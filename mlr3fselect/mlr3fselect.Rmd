...
```{r, results='hide'}
at = AutoFSelector$new(learner, resampling,
...
```{r, results='hide'}
at = auto_fselector(method = "random_search",
...
```{r, results='hide', class.source='example'}
inner = rsmp("holdout")
at = auto_fselector(method = "random_search", learner, inner, measure, term_evals = 20)
