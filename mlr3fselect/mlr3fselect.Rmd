...
```{r, eval=FALSE}
lgr::get_logger("mlr3/bbotk")$set_threshold("<level>")
```
...
```{r, results='hide'}
afs = auto_fselector(fselector = fselector,
  learner = learner, resampling = resampling,
  measure = measure, term_evals = 20)
```
...
```{r, results='hide', class.source='example nested_small'}
inner = rsmp("holdout")
