...
```{r, results='hide', class.source='example'}
as.data.table(instance$archive)
## >    Petal.Length Petal.Width Sepal.Length Sepal.Width classif.ce      resample_result
## > 1:         TRUE        TRUE         TRUE        TRUE 0.09333333 <ResampleResult[20]>
## > 2:         TRUE        TRUE         TRUE       FALSE 0.09333333 <ResampleResult[20]>
```
...
```{r, results='hide', class.source='example'}
instance = fselect(method = "random_search", task = tsk("penguins"), learner = learner, 
...
at = AutoFSelector$new(learner, resampling_inner, measure, evals20, fselector) 
