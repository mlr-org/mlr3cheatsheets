...
Evaluator and container for resampled performances of HPCs during tuning.
...
svm = lrn("classif.svm", kernel = "radial", type = "C-classification") 
ss = ps(
  cost = p_dbl(1e-4, 1e4, logscale = TRUE),
  gamma = p_dbl(1e-4, 1e4, logscale = TRUE))
evals = trm("evals", n_evals = 20)
instance = TuningInstanceSingleCrit$new(task, svm, resampling, measure, evals, ss)
