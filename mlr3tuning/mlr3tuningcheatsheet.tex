				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						\begin{myblock}{Terminator Class}
							...
							\vspace{1em}
							\begin{codebox}
								mlr\_terminators\$\textbf{keys}(pattern = NULL)
							\end{codebox}
							Lists available \codeinline{Terminator} classes.
							\\
							\begin{codebox}
				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						\begin{myblock}{Tuner Class}
							...
							\vspace{1em}
							\begin{codebox}
								mlr\_tuners\$\textbf{keys}(pattern = NULL)
							\end{codebox}
							Lists available \codeinline{Tuner} classes.
						\end{myblock}
