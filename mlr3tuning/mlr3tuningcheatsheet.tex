				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						...
						\begin{myblock}{ParamSet}
                            ...
                            \\
                            Dependencies prevent hyperparameter configurations that are not usable by the learner.
                            \\
							\begin{codebox}
				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						...
						\begin{myblock}{Running the Tuning}
							...
							\end{codebox}
							Starts the tuning (4). \codeinline{Tuner} generates candidate configurations
