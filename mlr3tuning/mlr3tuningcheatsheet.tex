				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						...
						\begin{myblock}{ParamSet - Params and Ranges}
                            ...
                            \\
                            Dependencies prevent configurations during tuning which are invalid in the learner.
                            \\
							\begin{codebox}
				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
                        ...
                        \begin{myblock}{TuningInstance - Search Scenario}
                            ...
                            Its main (internal) function \codeinline{eval\_batch(dt)} calls \codeinline{benchmark()} to evaluate a table of HP configurations. 
