...
rr = resample(task, learner, resampling)
rr$score(msr("classif.ce", predict_sets = "train"))
## >            resampling iteration   classif.ce
## > 1: <ResamplingCV[19]>         1    0.1601562
## > 2: <ResamplingCV[19]>         2    0.1464844

rr$score(msr("classif.ce", predict_sets = "test"))
## >            resampling iteration   classif.ce
## > 1: <ResamplingCV[19]>         1    0.2695312
## > 2: <ResamplingCV[19]>         2    0.2656250
```
