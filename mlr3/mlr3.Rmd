...
* Regression: `mtcars`, `california_housing`
...
* `weights_learner` - Observation weights for training.
* `weights_measure` - Observation weights for scoring.
...
[github.com/mlr-org/mlr3learners](https://github.com/mlr-org/mlr3learners) holds all available learners.
...
bmr = benchmark(design)
```
Returns a `BenchmarkResult` container.
...
```{r, eval=FALSE}
lgr::get_logger("mlr3/core")$set_threshold("<level>")
```
...
If learner fails, the fallback learner is used to generate predictions.
...
* [mlr3learners](https://github.com/mlr-org/mlr3learners)<br>
