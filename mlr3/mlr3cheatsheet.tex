					...
					\parbox[t][\columnheight]{\textwidth}{
						\begin{myblock}{Task Class}
                            ...
                            \begin{itemize}
                                ...
                                \item Inspect \codeinline{mlr\_tasks} for more.
                            \end{itemize}
							\vspace{1em}
							\begin{codebox}
					...
					\parbox[t][\columnheight]{\textwidth}{
	                    ...
	                    \begin{myblock}{Measures \& Scoring}
							...
							\begin{itemize}
                                ...
                                \item Inspect \codeinline{mlr\_measures} for more.
							\end{itemize}
							\vspace{1em}
							\begin{codebox}
					...
					\parbox[t][\columnheight]{\textwidth}{
						\begin{myblock}{mlr3viz}
							...
							\begin{itemize}
								...
								\item \codeinline{TaskClassif} (barplot of \codeinline{target}, \codeinline{duo} target-features plot matrix, \codeinline{pairs} feature plot matrix with color set to target)
						...
						\begin{myblock}{Error Handling and Encapsulation}
                            Packages \codeinline{evaluate} and \codeinline{callr} are used internally to encapsulate execution of \codeinline{\$train} and \codeinline{\$predict} to prevent stops in case of errors and crashes - useful for larger experments. \codeinline{callr} runs both steps in separate R sessions.
							\\
                            ...
                            Use robust fallback, e.g. "featureless". Can ease pain when learners fail in edge-cases.
						\end{myblock}
						\begin{myblock}{Resources}
							\begin{itemize}
								...
								\item \href{https://mlr3gallery.mlr-org.com/}{mlr3gallery scripts}\\ (https://mlr3gallery.mlr-org.com/)
							\end{itemize}
						\end{myblock}
					\vfill}
				\end{minipage}
