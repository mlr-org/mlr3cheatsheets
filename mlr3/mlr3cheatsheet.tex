						...
						\begin{myblock}{Resample}
							...
							\begin{codeboxexample}
								\scriptsize{
									...
									\\
									bmr\$aggregate()\\
									\#\# nr \monospace{2}resample\_result task\_id ... classif.ce\\
									\#\#\monospace{2}1\monospace{2}<ResampleResult>\monospace{3}sonar ... 0.26928916\\
									\#\#\monospace{2}2\monospace{2}<ResampleResult>\monospace{3}sonar ... 0.17798482\\
									\#\#\monospace{2}3\monospace{2}<ResampleResult>\monospace{4}spam ... 0.10106500\\
									\#\#\monospace{2}4\monospace{2}<ResampleResult>\monospace{4}spam ... 0.10106500}
							\end{codeboxexample}
