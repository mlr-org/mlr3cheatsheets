						...
						\begin{myblock}{Resample}
							...
							\begin{codeboxexample}
								\scriptsize{
									...
									\\
									bmr\$aggregate()\\
									\#\# nr \monospace{2}res\_result task\_id\monospace{5}learner\_id ... classif.ce\\
									\#\#\monospace{2}1\monospace{2}<ResResult>\monospace{3}sonar
									\monospace{1}classif.rpart ... 0.26928916\\
									\#\#\monospace{2}2\monospace{2}<ResResult>\monospace{3}sonar
									classif.ranger ... 0.17798482\\
									\#\#\monospace{2}3\monospace{2}<ResResult>\monospace{4}spam
									\monospace{1}classif.rpart ... 0.10106500\\
									\#\#\monospace{2}4\monospace{2}<ResResult>\monospace{4}spam
