						...
						\begin{myblock}{Resample}
							...
							\begin{codeboxexample}
								\scriptsize{
									...
									\monospace{12}cv\monospace{4}3 ...\\
									\#\#\monospace{2}3\monospace{4}spam\monospace{2}classif.rpart           \monospace{12}cv\monospace{4}3 ...\\
									\#\#\monospace{2}4\monospace{4}spam classif.ranger
									\monospace{12}cv\monospace{4}3 ...\\
									\vspace{1em}
									\\
									bmr\$aggregate()\\
									\#\#\monospace{2}resample\_result ... classif.ce\\
									\#\# <ResampleResult> ... 0.26928916\\
									\#\# <ResampleResult> ... 0.17798482\\
									\#\# <ResampleResult> ... 0.10106500\\
									\#\# <ResampleResult> ... 0.10106500
								}
							\end{codeboxexample}
							\end{myblock}
