			...
			\begin{beamercolorbox}[center]{postercolumn}
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						...
						Resampling is used to assess the performance of a learning algorithm by randomly drawing samples from a data set. mlr3 entails 6 predefined resampling strategies:
						\\
						\begin{itemize}
				...
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						\begin{myblock}{Resample \& Benchmark}
							In order to get the performance of a learning algorithm the \codeinline{resample} function is called.
							\\
							\begin{codebox}
