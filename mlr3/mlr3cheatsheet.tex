			...
			\begin{beamercolorbox}[center]{postercolumn}
				\begin{minipage}{.98\textwidth}
					...
					\begin{myblock}{Task Class}
						...
						\vspace{1em}
						\\
						Roles affect the behavior of the task for different operations.
						\\
						\begin{codebox}
							task\$\textbf{col\_roles}\$<role> = <column\_name>
						\end{codebox}
						Changes role of columns.
						\\
						\begin{codebox}
							task\$\textbf{row\_roles}\$<role> = <row\_ids>
						\end{codebox}
						Changes role of rows e.g. to \codeinline{use} or \codeinline{validation}.
						\\
						\begin{codebox}
